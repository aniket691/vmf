...
const InvoicePage = () => {
  ...
  return (
    <div className="max-w-8xl mx-auto p-6 bg-white shadow-lg rounded-lg mt-10">
        ...
        <div className="w-2/5 mx-auto p-6 bg-white shadow-md rounded-lg">
          ...
          <div className="flex space-x-4 mb-6">
            ...
            <div className="flex-1">
              ...
              {/* Only show input if receipt is not already uploaded */}
              ...
              {/* Always show View Receipt if it exists */}
              {documentData.receipt_url && (
                <button
                  onClick={() => {
                    setPreviewReceiptFile(documentData.receipt_url);
                    setShowPreview(true);
                  }}
            ...
            <div className="flex-1">
              ...
              {/* Only show upload input if certificate is not already uploaded */}
              {!certificates.some(
              ...
              {/* Always show View Certificate if available */}
              {certificates.some(
                (c) => String(c.document_id) === String(documentId)
              ) && (
                <button
      ...
      {(previewFile || previewReceiptFile) && (
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            >
              ...
              <h3 className="text-xl font-medium mb-4 text-center">
                {previewReceiptFile ? "Receipt Preview" : "Certificate Preview"}
              </h3>
              <iframe
                src={previewReceiptFile || previewFile}
