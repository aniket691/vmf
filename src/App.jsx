...
import WalletHistoryD from "./Components/WalletHistoryD";
    ...
    <Router>
      <Routes>
        ...
        <Route
          ...
          element={
            <Admindashboard>
              <ReceiptErrorRequests />
            </Admindashboard>
          }
        />

        <Route
          path="/Adminerrorhistory"
          element={
            <Admindashboard>
              <Adminerrorhistory />
            </Admindashboard>
        ...
        />
        <Route
          path="/Customererrorhistory"
          element={
            <Customerdashboard>
              <Customererrorhistory />
            </Customerdashboard>
          }
        />
        <Route
        ...
        />
        <Route
          path="/Customerinvoice/:documentId"
        ...
        />
        <Route
          path="/Distributorinvoice/:documentId"
          element={<Distributorinvoice />}
        />
        <Route
          path="/Distributorview/:documentId"
